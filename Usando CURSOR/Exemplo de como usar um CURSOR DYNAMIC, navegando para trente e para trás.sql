/*
    Dynamic Cursor (Dinâmico)

    - Enxerga todas as mudanças feitas na tabela enquanto está aberto.
    - Pode navegar para frente e para trás.
    - Mais lento porque acompanha mudanças em tempo real.
*/
...
-- Criando Cursor
DECLARE CUR_CLIENTE CURSOR DYNAMIC FOR
